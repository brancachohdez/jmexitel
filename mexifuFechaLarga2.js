$.when(
	...
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jshaolin@master/pdf.js'),
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jshaolin@master/cbl.js'),
...
function initialize() {
	PDFJS.workerSrc = 'https://cdn.jsdelivr.net/gh/brancachohdez/jshaolin@master/pdf.worker.js';
	cbl = new CBL({
...
var MX_AJAX = function(person) {
    ...
    async function fetchSchedule(person) {
        ...
        payload['formRegistroCitaExtranjero:noPasapAnt'] = person.passport;
        payload['formRegistroCitaExtranjero:selectTramite_input'] = "12";
        payload['formRegistroCitaExtranjero:schedule_start'] = new Date(2018, 7, 15, 0, 0, 0, 0).getTime().toString();
        payload['formRegistroCitaExtranjero:schedule_end'] = new Date(2019, 8, 31, 0, 0, 0, 0).getTime().toString();
        payload = Object.assign(payload, payloads.agendaWeekSinPermiso);
        payload['formRegistroCitaExtranjero:selectTipoTramite_input'] = "63";
