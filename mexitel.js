$.when(
	...
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jmexitel@master/mexitel.ajax.js'),
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jmexitel@master/pdf.js'),
	$.getScript('https://cdn.jsdelivr.net/gh/brancachohdez/jmexitel@master/cbl.js'),
...
function initialize() {
	PDFJS.workerSrc = 'https://cdn.jsdelivr.net/gh/brancachohdez/jmexitel@master/pdf.worker.js';
	cbl = new CBL({
